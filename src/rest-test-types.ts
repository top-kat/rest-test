...
interface Test2<TestUserNames extends string, ConnexionInfos extends Record<string, any>, RestTestConfigType extends RestTestConfig> {
    ...
    /** This test will run in parallel of the other ones, so the flow will continue while this test is finishing */
...
export type TestItem<TestUserNames extends string = any, ConnexionInfos extends Record<string, any> = any, RestTestConfigType extends RestTestConfig = any> = (TestElement<TestUserNames, ConnexionInfos, RestTestConfigType> | TestFlow<TestUserNames, ConnexionInfos, RestTestConfigType>)


export type TestFlowRaw<TestUserNames extends string = any, ConnexionInfos extends Record<string, any> = any, RestTestConfigType extends RestTestConfig = any> = {
    name?: string
    ...
    mandatory?: boolean
    /** if active, only this test flow will run and the mandatory ones. Remove this when commiting */
    solo?: boolean
    ...
    /** This is meant to be played before reloading a test flow when a user click continue or
     *  replayLast when a previous test has failed
     */
    beforeReloadAll?: TestElement<TestUserNames, ConnexionInfos, RestTestConfigType>[]
}

export type TestFlow<TestUserNames extends string = any, ConnexionInfos extends Record<string, any> = any, RestTestConfigType extends RestTestConfig = any> = TestFlowRaw<TestUserNames, ConnexionInfos, RestTestConfigType> | (() => MaybePromise<TestFlowRaw<TestUserNames, ConnexionInfos, RestTestConfigType>>)
...
export type TestElement<TestUserNames extends string, ConnexionInfos extends Record<string, any>, RestTestConfigType extends RestTestConfig> =
    ...
    TestFlow<TestUserNames, ConnexionInfos, RestTestConfigType>
